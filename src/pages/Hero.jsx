      ...
      >
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              Hai trái tim – một hành trình, và chúng mình sắp về chung một nhà!
            </motion.p>
            <motion.h2
              initial={{ scale: 0.8, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
              transition={{ delay: 0.6 }}
              className="py-1 text-3xl sm:text-5xl font-serif bg-clip-text text-transparent bg-gradient-to-r from-rose-600 to-pink-600"
            >
              ...
              <div className="space-y-6 text-center">
                ...
                >
                  ...
                  <p className="text-rose-500 font-semibold text-lg">
                    {guestName ? guestName : "Người thương đáng quý 💕"}
                  </p>
                  <p className="text-gray-600 font-medium text-sm">
                    Đến dự buổi tiệc cưới của chúng mình
                  </p>
                </motion.div>
              </div>
